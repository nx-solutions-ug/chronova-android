...
The authorization header is formatted as `Bearer $apiKey` inside the repository. `getCurrentUser` is also used to determine PRO status and to store the user ID for leaderboard highlighting.
