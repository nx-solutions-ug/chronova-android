...
| `user_id` | Logged-in user ID, used for leaderboard highlighting | `null` |
...
suspend fun getGoalSuggestions(): Result<GoalSuggestionsResponse>
...
The service also exposes endpoints for the newer PRO and social features:
